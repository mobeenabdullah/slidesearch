        ...
        foreach($files as $file) : ?>
            ...
            <div class="single-slide">
                ...
                <div class="slide-actions">
                    <ul>
                        <li>
                            <a href="#" class="button button-primary" title="Download Slide"><i class="fa fa-download"></i></a>
                        </li>
                        <li>
                            <a href="#" class="button button-update" title="Update Tags"><i class="fa fa-tags"></i></a>
                        </li>
                        <li>
                            <a href="#" class="button button-delete" title="Delete Slide"><i class="fa fa-close"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
